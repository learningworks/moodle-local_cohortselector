YUI.add('moodle-local_cohortselector-selector', function (Y, NAME) {
...
M.local_cohortselector.selector = {
     ...
     * @type String
     */
    AJAX_SEARCH_URL: M.cfg.wwwroot + '/local/cohortselector/search.ajax.php?q={query}&id={id}&sesskey={sesskey}',
     ...
     * @property options
     */
    options : ['searchanywhere', 'name', 'idnumber', 'description'],
